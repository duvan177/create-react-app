...
export default function FormEstacion() {       
      ...
      >
        ...
        >
          ...
          <div
              ...
              className="col-md-12  d-flex justify-content-center align-items-center"
            >
              <h5 primary>Datos la estacion</h5>
            ...
            >       
              ...
              <div className="form-group">
                <label htmlFor="codigoAlarma">Codigo alarma:</label>
                <select
                  className="form-control"
                  id="codigoAlarma"
                  name="codigoAlarma"
                  required
                  defaultValue={user.codigoAlarma}
                >
                  <option value="">Seleccione</option>
                  <option value="1">codAlarma1</option>
                </select>
              </div>
            </div>
            <div
            ...
            >       
            <div className="form-group">
                <label htmlFor="codigoSensor">Codigo sensor:</label>
                <select
                  className="form-control"
                  id="codigoSensor"
                  name="codigoSensor"
                  required
                  defaultValue={user.codigoSensor}
                >
                  <option value="">Seleccione</option>
                  <option value="1">codsensor1</option>
                </select>
              </div>
